...
/**
 * Initializes the global MT19937 context.
 *
...
/**
 * Fills a buffer with words generated by the global MT19937 context.
 *
 * Generation is serialized by a global spin lock. Both the buffer address and
 * \p size must be four-byte aligned.
 *
 * @param[out] buffer - Destination buffer.
 * @param[in] size - Number of bytes to fill.
 *
 * @return 0 on success, ::SCE_KERNEL_ERROR_INVALID_ARGUMENT if the address or
 * size is not four-byte aligned.
 */
